...
- 앱은 시작 15초 뒤 자동 확인을 시도합니다. 마지막으로 확인에 성공한 지 24시간이 지나지 않았다면 자동 확인을 건너뜁니다. 최신 버전일 때는 아무 창도 띄우지 않고, 더 새 버전이 있을 때만 **새 버전이 있습니다** 창을 띄웁니다. 설정 화면이나 트레이 메뉴에서는 언제든 직접 확인할 수 있습니다.
...
| 사용자 승인 업데이트 | 앱 시작 15초 뒤 새 버전을 확인하고, 성공한 확인 뒤 24시간 동안 자동 재확인을 생략하며, 사용자가 동의한 경우에만 검증된 설치 파일을 내려받아 설치·재시작 |
...
- 업데이트 확인에 성공하면 24시간 동안 자동으로 다시 확인하지 않습니다. 네트워크 연결에 실패하면 다음 앱 시작 때 다시 시도할 수 있으며, 설정 화면이나 트레이 메뉴에서는 언제든 직접 확인할 수 있습니다.
